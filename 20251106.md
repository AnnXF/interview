...
I have over three years development experiense which includes data analysis, SLG game and desktop application.

My most recent role mainly involved developing a desktop application for generating crypto  reports.

the tech stack mainly inlcudes go, python, rust, electron and sqlite.  In addtion, it integrates some tool suchs as wireshark and libreoffice

In the work related to the game, I was mainly responsible for the development of gift packs and activities.

The  tech stack includes go, redis and memcache.

Finally, in the work of data analysis, I was mainly responsible for extracting some early warning data for other departments.

The  tech stack include python, flask, pandas and so on。
